...
export default function GameFrame({ jeu, width = 140, height = 280, fill = false, large = false, onStartRequest, onScore, onEcranScinde, ecranScindeActif = false }) {
  ...
  function preparerContexte() {
    ...
    // PAS opaque (plus de { alpha: false }) : ce réglage fait prendre au canvas un autre chemin de rendu sur Chrome
    // Android, où les jeux restaient vides. Chaque jeu peint tout son fond de toute façon ; le gain était minime.
