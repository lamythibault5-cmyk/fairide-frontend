...
const KEYWORD_IMAGES = [
  ...
  { keywords: ['philadelphia roll', 'unagi roll'], image: 'https://images.unsplash.com/photo-1617196034183-421b4917c92d?w=300&q=80' },
  ...
  { keywords: ['ayran'], image: 'https://images.unsplash.com/photo-1622483767028-3f66f32aef97?w=300&q=80' },

  // --- Turc / Kebab (spécifique) ---
  { keywords: ['iskender'], image: 'https://images.unsplash.com/photo-1529006557810-274b9b2fc783?w=300&q=80' },
  { keywords: ['lahmacun'], image: 'https://images.unsplash.com/photo-1600628421066-f6bda6a7b976?w=300&q=80' },
  { keywords: ['pide'], image: 'https://images.unsplash.com/photo-1601924582970-9238bcb495d9?w=300&q=80' },
  { keywords: ['böreks', 'boreks', 'sigara böregi', 'sigara boregi', 'cigares au fromage'], image: 'https://images.unsplash.com/photo-1608039755401-742074f0548d?w=300&q=80' },
  ...
  { keywords: ['sütlaç', 'sutlac', 'riz au lait'], image: 'https://images.unsplash.com/photo-1517093157656-b9eccef91cb1?w=300&q=80' },
  { keywords: ['salgam', 'şalgam'], image: 'https://images.unsplash.com/photo-1622483767028-3f66f32aef97?w=300&q=80' },
  ...
  { keywords: ['accras', 'pastels', 'beignets de crevettes'], image: 'https://images.unsplash.com/photo-1541014741259-de529411b96a?w=300&q=80' },
  ...
  { keywords: ['sprite'], image: 'https://images.unsplash.com/photo-1622483767028-3f66f32aef97?w=300&q=80' },
  ...
  { keywords: ['limonade', 'lemonade', 'limeade', 'citronnade'], image: 'https://images.unsplash.com/photo-1621263764928-df1444c5e859?w=300&q=80' },
