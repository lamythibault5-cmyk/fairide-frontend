...
export const CATEGORIES = [
  { value: 'entree', label: 'Entrées', image: 'https://images.unsplash.com/photo-1626200419199-391ae4be7a41?w=600&q=80' },
  { value: 'plat', label: 'Plats', image: 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=600&q=80' },
  { value: 'dessert', label: 'Desserts', image: 'https://images.unsplash.com/photo-1488477181946-6428a0291777?w=600&q=80' },
  { value: 'boisson', label: 'Boissons', image: 'https://images.unsplash.com/photo-1544145945-f90425340c7e?w=600&q=80' }
];
...
const KEYWORD_IMAGES = [
  ...
  { keywords: ['double cheeseburger', 'double smash', 'double burger', 'double chicken burger'], image: 'https://images.unsplash.com/photo-1550317138-10000687a72b?w=600&q=80' },
  { keywords: ['bacon cheeseburger', 'bacon burger'], image: 'https://images.unsplash.com/photo-1586190848861-99aa4a171e90?w=600&q=80' },
  { keywords: ['bbq bacon', 'bbq burger', 'bbq chicken burger'], image: 'https://images.unsplash.com/photo-1610614819513-58e34989848b?w=600&q=80' },
  { keywords: ['crispy chicken burger', 'spicy chicken burger', 'chicken burger', 'poulycroc', 'original chicken burger'], image: 'https://images.unsplash.com/photo-1607013251379-e6eecfffe234?w=600&q=80' },
  { keywords: ['veggie burger', 'vegetarian burger'], image: 'https://images.unsplash.com/photo-1520072959219-c595dc870360?w=600&q=80' },
  { keywords: ['smash burger'], image: 'https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=600&q=80' },
  { keywords: ['blue cheese burger', 'truffle burger', 'oklahoma onion burger', 'avocado chicken burger', 'bicky'], image: 'https://images.unsplash.com/photo-1610440042657-612c34d95e9f?w=600&q=80' },
  { keywords: ['cheeseburger', 'burger', 'hamburger'], image: 'https://images.unsplash.com/photo-1571091718767-18b5b1457add?w=600&q=80' },

  // --- Fries & sides ---
  { keywords: ['sweet potato fries'], image: 'https://images.unsplash.com/photo-1596097635121-14b63b7a0c23?w=600&q=80' },
  { keywords: ['loaded cheese fries', 'cheese fries', 'bacon & cheese fries', 'frites cheddar', 'cajun fries'], image: 'https://images.unsplash.com/photo-1666304752980-678d5c35c911?w=600&q=80' },
  { keywords: ['onion rings'], image: 'https://images.unsplash.com/photo-1652209911920-2700fcbd5011?w=600&q=80' },
  { keywords: ['nuggets'], image: 'https://images.unsplash.com/photo-1619881590738-a111d176d906?w=600&q=80' },
  { keywords: ['wings', 'ailes'], image: 'https://images.unsplash.com/photo-1608039755401-742074f0548d?w=600&q=80' },
  { keywords: ['coleslaw'], image: 'https://images.unsplash.com/photo-1573403707491-38a4ea19edc1?w=600&q=80' },
  { keywords: ['frite', 'french fries', 'fries'], images: ['https://images.unsplash.com/photo-1573080496219-bb080dd4f877?w=600&q=80', 'https://images.unsplash.com/photo-1630384060421-cb20d0e0649d?w=600&q=80', 'https://images.unsplash.com/photo-1518013431117-eb1465fa5752?w=600&q=80'] },

  // --- Pizzas (par variante) ---
  { keywords: ['margherita', 'marinara', 'napoli', 'napoletana'], image: 'https://images.unsplash.com/photo-1513104890138-7c749659a591?w=600&q=80' },
  { keywords: ['pepperoni', 'diavola', 'spicy pizza'], image: 'https://images.unsplash.com/photo-1590947132387-155cc02f3212?w=600&q=80' },
  { keywords: ['quattro formaggi', 'quattro stagioni', 'capricciosa', 'parma', 'mortadella'], image: 'https://images.unsplash.com/photo-1571066811602-716837d681de?w=600&q=80' },
  { keywords: ['burrata pizza', 'pizza burrata', 'tartufata', 'truffle pizza'], image: 'https://images.unsplash.com/photo-1548369937-47519962c11a?w=600&q=80' },
  { keywords: ['calzone', 'pizza vegetariana', 'vegetariana', 'pizza hawaïenne', 'pizza tonno', 'pizza regina', 'prosciutto'], image: 'https://images.unsplash.com/photo-1571407970349-bc81e7e96d47?w=600&q=80' },
  { keywords: ['pizza'], image: 'https://images.unsplash.com/photo-1600028068383-ea11a7a101f3?w=600&q=80' },

  // --- Pâtes (par variante) ---
  { keywords: ['carbonara'], image: 'https://images.unsplash.com/photo-1551183053-bf91a1d81141?w=600&q=80' },
  { keywords: ['bolognese', 'bolognaise', 'ragù', 'ragu'], image: 'https://images.unsplash.com/photo-1621996346565-e3dbc646d9a9?w=600&q=80' },
  { keywords: ['arrabbiata', 'amatriciana', 'vodka'], image: 'https://images.unsplash.com/photo-1608897013039-887f21d8c804?w=600&q=80' },
  { keywords: ['pesto'], image: 'https://images.unsplash.com/photo-1567608285969-48e4bbe0d399?w=600&q=80' },
  { keywords: ['gnocchi'], image: 'https://images.unsplash.com/photo-1616170687881-32188ae1b6d7?w=600&q=80' },
  { keywords: ['ravioli'], image: 'https://images.unsplash.com/photo-1628885363743-fbf9c98d4196?w=600&q=80' },
  { keywords: ['lasagne', 'lasagna'], image: 'https://images.unsplash.com/photo-1621996346565-e3dbc646d9a9?w=600&q=80' },
  { keywords: ['pâtes', 'pate', 'pasta', 'tagliatelle', 'linguine', 'rigatoni', 'fettuccine', 'penne', 'spaghetti'], images: ['https://images.unsplash.com/photo-1551183053-bf91a1d81141?w=600&q=80', 'https://images.unsplash.com/photo-1628885363743-fbf9c98d4196?w=600&q=80', 'https://images.unsplash.com/photo-1608897013039-887f21d8c804?w=600&q=80'] },
  { keywords: ['risotto'], image: 'https://images.unsplash.com/photo-1682428617976-f25633ed8469?w=600&q=80' },

  // --- Entrées italiennes ---
  { keywords: ['focaccia'], image: 'https://images.unsplash.com/photo-1619452357216-e88ca8119eeb?w=600&q=80' },
  { keywords: ['garlic bread'], image: 'https://images.unsplash.com/photo-1573140401552-3fab0b24306f?w=600&q=80' },
  { keywords: ['bruschetta'], image: 'https://images.unsplash.com/photo-1506280754576-f6fa8a873550?w=600&q=80' },
  { keywords: ['carpaccio', 'tataki'], image: 'https://images.unsplash.com/photo-1727243866425-3bf2cbf7480a?w=600&q=80' },
  { keywords: ['corn on the cob', 'corn on cob', 'épi de maïs'], image: 'https://images.unsplash.com/photo-1653886764193-db9e5a93d215?w=600&q=80' },
  { keywords: ['burrata', 'caprese', 'antipasti'], image: 'https://images.unsplash.com/photo-1623855244697-5d8fbe9c7892?w=600&q=80' },
  { keywords: ['arancini'], image: 'https://images.unsplash.com/photo-1632778140142-d62dee6e124c?w=600&q=80' },
  { keywords: ['vitello tonnato', 'osso buco', 'saltimbocca'], image: 'https://images.unsplash.com/photo-1773417325310-cc9c9bef75e7?w=600&q=80' },
  { keywords: ['affogato'], image: 'https://images.unsplash.com/photo-1461023058943-07fcbe16d735?w=600&q=80' },
  { keywords: ['gelato'], image: 'https://images.unsplash.com/photo-1572837663132-76c0ccd9cb6f?w=600&q=80' },

  // --- Sushi / Japonais ---
  { keywords: ['nigiri', 'sashimi'], image: 'https://images.unsplash.com/photo-1553621042-f6e147245754?w=600&q=80' },
  { keywords: ['california roll'], image: 'https://images.unsplash.com/photo-1617196034183-421b4917c92d?w=600&q=80' },
  { keywords: ['philadelphia roll', 'unagi roll', 'vegetable roll'], image: 'https://images.unsplash.com/photo-1617196034183-421b4917c92d?w=600&q=80' },
  { keywords: ['rainbow roll', 'ebi roll', 'futomaki'], image: 'https://images.unsplash.com/photo-1580822184713-fc5400e7fe10?w=600&q=80' },
  { keywords: ['spicy salmon roll', 'spicy tuna roll', 'salmon avocado roll', 'crispy chicken roll', 'shrimp tempura roll', 'dragon roll'], image: 'https://images.unsplash.com/photo-1611143669185-af224c5e3252?w=600&q=80' },
  { keywords: ['maki'], image: 'https://images.unsplash.com/photo-1579584425555-c3ce17fd4351?w=600&q=80' },
  { keywords: ['salmon box', 'california box', 'sushi mix', 'salmon lovers', 'sushi deluxe', 'veggie box', 'chirashi', 'sushi'], image: 'https://images.unsplash.com/photo-1553621042-f6e147245754?w=600&q=80' },
  { keywords: ['gyoza'], image: 'https://images.unsplash.com/photo-1738681336104-608b4e7dc3b0?w=600&q=80' },
  { keywords: ['wakame'], image: 'https://images.unsplash.com/photo-1690789627117-eb8d3b6a46f4?w=600&q=80' },
  { keywords: ['miso'], image: 'https://images.unsplash.com/photo-1680137248903-7af5d51a3350?w=600&q=80' },
  { keywords: ['dorayaki'], image: 'https://images.unsplash.com/photo-1626497132810-f38eb29c5385?w=600&q=80' },
  { keywords: ['saké', 'sake chaud'], image: 'https://images.unsplash.com/photo-1664477407933-dd42ed0c6c62?w=600&q=80' },
  { keywords: ['ramune'], image: 'https://images.unsplash.com/photo-1663870316229-cb3986d34e8c?w=600&q=80' },

  // --- Asiatique / Wok ---
  { keywords: ['spring rolls', 'rouleaux de printemps', 'nems', 'nem'], image: 'https://images.unsplash.com/photo-1679310290259-78d9eaa32700?w=600&q=80' },
  { keywords: ['shrimp tempura', 'tempura crevette', 'tempura'], image: 'https://images.unsplash.com/photo-1579887829114-282b4fa31072?w=600&q=80' },
  { keywords: ['edamame'], image: 'https://images.unsplash.com/photo-1649257171206-37625b1f3b2f?w=600&q=80' },
  { keywords: ['satay'], image: 'https://images.unsplash.com/photo-1772855386828-a18ff9a12584?w=600&q=80' },
  { keywords: ['pad thai', 'pad thaï'], image: 'https://images.unsplash.com/photo-1746973645769-c11eb0a81025?w=600&q=80' },
  { keywords: ['fried rice', 'riz cantonais', 'riz sauté'], image: 'https://images.unsplash.com/photo-1603133872878-684f208fb84b?w=600&q=80' },
  { keywords: ['teriyaki'], image: 'https://images.unsplash.com/photo-1609183480237-ccbb2d7c5772?w=600&q=80' },
  { keywords: ['sweet & sour', 'general tao', 'bœuf aux oignons', 'boeuf aux oignons'], image: 'https://images.unsplash.com/photo-1664138788119-bd4f073259d5?w=600&q=80' },
  { keywords: ['thai green curry', 'thai red curry', 'curry vert', 'curry rouge'], image: 'https://images.unsplash.com/photo-1716959669858-11d415bdead6?w=600&q=80' },
  { keywords: ['singapore noodles', 'noodles', 'bo bun', 'nouilles'], images: ['https://images.unsplash.com/photo-1555126634-323283e090fa?w=600&q=80', 'https://images.unsplash.com/photo-1609183480237-ccbb2d7c5772?w=600&q=80', 'https://images.unsplash.com/photo-1603133872878-684f208fb84b?w=600&q=80'] },
  { keywords: ['mango sticky rice'], image: 'https://images.unsplash.com/photo-1711161988375-da7eff032e45?w=600&q=80' },
  { keywords: ['coconut tapioca'], image: 'https://images.unsplash.com/photo-1601654847092-712aff26313c?w=600&q=80' },
  { keywords: ['lychee'], image: 'https://images.unsplash.com/photo-1597975371270-cf80e4f54921?w=600&q=80' },
  { keywords: ['tom yum'], image: 'https://images.unsplash.com/photo-1628430043175-0e8820df47c3?w=600&q=80' },
  { keywords: ['bao'], image: 'https://images.unsplash.com/photo-1675096000167-4b8a276b6187?w=600&q=80' },
  { keywords: ['papaye verte', 'mangue verte'], image: 'https://images.unsplash.com/photo-1648421331147-9fcfab29536e?w=600&q=80' },
  { keywords: ['canard laqué', 'canard laque'], image: 'https://images.unsplash.com/photo-1518492104633-130d0cc84637?w=600&q=80' },
  { keywords: ['mi krob'], image: 'https://images.unsplash.com/photo-1555126634-323283e090fa?w=600&q=80' },
  { keywords: ['bubble tea'], image: 'https://images.unsplash.com/photo-1558857563-b371033873b8?w=600&q=80' },
  { keywords: ['nouilles froides'], image: 'https://images.unsplash.com/photo-1555126634-323283e090fa?w=600&q=80' },
  { keywords: ['eau de coco'], image: 'https://images.unsplash.com/photo-1603779046675-2eccbab9b982?w=600&q=80' },

  // --- Mexicain ---
  { keywords: ['burrito bowl', 'vegan bowl', 'shrimp bowl'], image: 'https://images.unsplash.com/photo-1543339308-43e59d6b73a6?w=600&q=80' },
  { keywords: ['burrito'], image: 'https://images.unsplash.com/photo-1626700051175-6818013e1d4f?w=600&q=80' },
  { keywords: ['tacos'], image: 'https://images.unsplash.com/photo-1665541719551-655b587161e4?w=600&q=80' },
  { keywords: ['loaded nachos', 'nachos'], image: 'https://images.unsplash.com/photo-1582169296194-e4d644c48063?w=600&q=80' },
  { keywords: ['guacamole'], image: 'https://images.unsplash.com/photo-1600728256404-aaa448921ad9?w=600&q=80' },
  { keywords: ['mexican rice', 'black beans'], image: 'https://images.unsplash.com/photo-1543353071-10c8ba85a904?w=600&q=80' },
  { keywords: ['quesadilla'], image: 'https://images.unsplash.com/photo-1618040996337-56904b7850b9?w=600&q=80' },
  { keywords: ['churros'], image: 'https://images.unsplash.com/photo-1624371414361-e670edf4898d?w=600&q=80' },
  { keywords: ['tres leches'], image: 'https://images.unsplash.com/photo-1557925923-33b27f891f88?w=600&q=80' },
  { keywords: ['jarritos'], image: 'https://images.unsplash.com/photo-1632852521784-d85d5b62dd62?w=600&q=80' },

  // --- Libanais / Méditerranéen ---
  { keywords: ['hummus beiruti', 'hummus', 'houmous'], image: 'https://images.unsplash.com/photo-1673960854897-749f9d9ebafc?w=600&q=80' },
  { keywords: ['moutabal', 'baba ganoush'], image: 'https://images.unsplash.com/photo-1627308595127-d9acf19107ce?w=600&q=80' },
  { keywords: ['labneh'], image: 'https://images.unsplash.com/photo-1641494587136-eec74f1944ae?w=600&q=80' },
  { keywords: ['tabbouleh', 'tabboulé', 'taboulé', 'fattoush'], image: 'https://images.unsplash.com/photo-1594040815645-5442fb6d48f6?w=600&q=80' },
  { keywords: ['falafel'], image: 'https://images.unsplash.com/photo-1593001872095-7d5b3868fb1d?w=600&q=80' },
  { keywords: ['kebbeh'], image: 'https://images.unsplash.com/photo-1663004940335-8e7d8f1a093c?w=600&q=80' },
  { keywords: ['halloumi'], image: 'https://images.unsplash.com/photo-1598511796432-32663d0875bd?w=600&q=80' },
  { keywords: ['shawarma'], image: 'https://images.unsplash.com/photo-1719282431565-3b30bb7d2658?w=600&q=80' },
  { keywords: ['mixed grill', 'mezze', 'meze'], image: 'https://images.unsplash.com/photo-1743674453093-592bed88018e?w=600&q=80' },
  { keywords: ['kafta'], image: 'https://images.unsplash.com/photo-1719282431565-3b30bb7d2658?w=600&q=80' },
  { keywords: ['mouhalabieh'], image: 'https://images.unsplash.com/photo-1600676626897-eb2fb18a21e0?w=600&q=80' },
  { keywords: ['kunafa', 'künefe', 'kunefe'], image: 'https://images.unsplash.com/photo-1619860862294-1e96abc03d5b?w=600&q=80' },
  { keywords: ['dates & nuts', 'dates'], image: 'https://images.unsplash.com/photo-1648288718348-4b6d53755716?w=600&q=80' },
  { keywords: ['ayran'], image: 'https://images.unsplash.com/photo-1558113583-d75f23fcb8a9?w=600&q=80' },

  // --- Turc / Kebab (spécifique) ---
  { keywords: ['iskender'], image: 'https://images.unsplash.com/photo-1529006557810-274b9b2fc783?w=600&q=80' },
  { keywords: ['lahmacun'], image: 'https://images.unsplash.com/photo-1741166985167-14b7178f15b7?w=600&q=80' },
  { keywords: ['pide'], image: 'https://images.unsplash.com/photo-1628281161295-269ade51d28d?w=600&q=80' },
  { keywords: ['böreks', 'boreks', 'sigara böregi', 'sigara boregi', 'cigares au fromage'], image: 'https://images.unsplash.com/photo-1767124559112-088d7d1cc000?w=600&q=80' },
  { keywords: ['adana', 'beyti', 'kofte', 'köfte'], image: 'https://images.unsplash.com/photo-1529006557810-274b9b2fc783?w=600&q=80' },
  { keywords: ['shish taouk', 'shish', 'brochette'], image: 'https://images.unsplash.com/photo-1529006557810-274b9b2fc783?w=600&q=80' },
  { keywords: ['loukoum'], image: 'https://images.unsplash.com/photo-1555148484-324aae683a86?w=600&q=80' },
  { keywords: ['sütlaç', 'sutlac', 'riz au lait'], image: 'https://images.unsplash.com/photo-1590055619273-44b5b6ce52e8?w=600&q=80' },
  { keywords: ['salgam', 'şalgam'], image: 'https://images.unsplash.com/photo-1542518392-13317b1ee2a2?w=600&q=80' },
  { keywords: ['thé turc'], image: 'https://images.unsplash.com/photo-1564890369478-c89ca6d9cde9?w=600&q=80' },

  // --- Cuisine africaine / ivoirienne ---
  { keywords: ['mafé', 'mafe'], image: 'https://images.unsplash.com/photo-1604329760661-e71dc83f8f26?w=600&q=80' },
  { keywords: ['alloco', 'manioc'], image: 'https://images.unsplash.com/photo-1762884601729-0eeeafbdfb8a?w=600&q=80' },
  { keywords: ['thieboudienne', 'thiéboudienne'], image: 'https://images.unsplash.com/photo-1512058564366-18510be2db19?w=600&q=80' },
  { keywords: ['yassa'], image: 'https://images.unsplash.com/photo-1603496987351-f84a3ba5ec85?w=600&q=80' },
  { keywords: ['attiéké', 'attieke'], image: 'https://images.unsplash.com/photo-1665332195309-9d75071138f0?w=600&q=80' },
  { keywords: ['kedjenou'], image: 'https://images.unsplash.com/photo-1604908176997-125f25cc6f3d?w=600&q=80' },
  { keywords: ['riz gras', 'sauce graine'], image: 'https://images.unsplash.com/photo-1543353071-873f17a7a088?w=600&q=80' },
  { keywords: ['accras', 'pastels', 'beignets de crevettes'], image: 'https://images.unsplash.com/photo-1696265498747-efc4c0dd7b98?w=600&q=80' },
  { keywords: ['bissap'], image: 'https://images.unsplash.com/photo-1598905875667-745166844c96?w=600&q=80' },
  { keywords: ['gâteau à l\'ananas', 'gateau ananas'], image: 'https://images.unsplash.com/photo-1643910509872-78bc24a2bc53?w=600&q=80' },

  // --- Healthy / Poke / Bowls ---
  { keywords: ['salmon poke', 'spicy salmon poke'], image: 'https://images.unsplash.com/photo-1604259596863-57153177d40b?w=600&q=80' },
  { keywords: ['tuna poke', 'spicy tuna poke'], image: 'https://images.unsplash.com/photo-1597958792579-bd3517df6399?w=600&q=80' },
  { keywords: ['teriyaki chicken poke', 'crispy chicken poke'], image: 'https://images.unsplash.com/photo-1602881916963-5daf2d97c06e?w=600&q=80' },
  { keywords: ['shrimp poke'], image: 'https://images.unsplash.com/photo-1780805663576-48cdd496138d?w=600&q=80' },
  { keywords: ['tofu poke', 'vegan poke', 'build your own poke', 'poke'], image: 'https://images.unsplash.com/photo-1490645935967-10de6ba17061?w=600&q=80' },
  { keywords: ['caesar', 'césar'], image: 'https://images.unsplash.com/photo-1512852939750-1305098529bf?w=600&q=80' },
  { keywords: ['mediterranean bowl', 'avocado quinoa bowl', 'protein chicken bowl', 'falafel bowl'], image: 'https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=600&q=80' },
  { keywords: ['açai', 'acai'], image: 'https://images.unsplash.com/photo-1490474418585-ba9bad8fd0ea?w=600&q=80' },
  { keywords: ['chia'], image: 'https://images.unsplash.com/photo-1642423453088-69ad302f0d3c?w=600&q=80' },
  { keywords: ['yaourt', 'yoghurt', 'yogurt', 'compote'], image: 'https://images.unsplash.com/photo-1571212515416-fef01fc43637?w=600&q=80' },
  { keywords: ['energy balls', 'barres céréales', 'barres cereales'], image: 'https://images.unsplash.com/photo-1678554500191-3885a6fbf8c2?w=600&q=80' },
  { keywords: ['galettes de quinoa', 'quinoa'], image: 'https://images.unsplash.com/photo-1630156948734-9f84d5ce6aee?w=600&q=80' },
  { keywords: ['perles de coco'], image: 'https://images.unsplash.com/photo-1596723455658-72ebb0d12edd?w=600&q=80' },
  { keywords: ['banana bread'], image: 'https://images.unsplash.com/photo-1569762404472-026308ba6b64?w=600&q=80' },
  { keywords: ['ginger shot'], image: 'https://images.unsplash.com/photo-1678890565859-a2dadf52a48f?w=600&q=80' },
  { keywords: ['green smoothie', 'mango smoothie', 'smoothie'], image: 'https://images.unsplash.com/photo-1610970881699-44a5587cabec?w=600&q=80' },
  { keywords: ['kombucha'], image: 'https://images.unsplash.com/photo-1783099993801-c31173919b72?w=600&q=80' },
  { keywords: ['coconut water'], image: 'https://images.unsplash.com/photo-1588413336019-dd5d3beddf55?w=600&q=80' },
  { keywords: ['toast avocat', 'avocado'], image: 'https://images.unsplash.com/photo-1603046891726-36bfd957e0bf?w=600&q=80' },

  // --- Fried Chicken / Wings ---
  { keywords: ['crispy tenders', 'tenders'], image: 'https://images.unsplash.com/photo-1626645738196-c2a7c87a8f58?w=600&q=80' },
  { keywords: ['hot wings'], image: 'https://images.unsplash.com/photo-1626082927389-6cd097cdc6ec?w=600&q=80' },
  { keywords: ['chicken bucket'], image: 'https://images.unsplash.com/photo-1652957392622-17e7c96f1369?w=600&q=80' },
  { keywords: ['mac & cheese', 'mac and cheese'], image: 'https://images.unsplash.com/photo-1667499989723-c4ab9549d63c?w=600&q=80' },
  { keywords: ['mozzarella sticks', 'jalapeño poppers', 'jalapeno poppers'], image: 'https://images.unsplash.com/photo-1548340748-6d2b7d7da280?w=600&q=80' },
  { keywords: ['donut'], image: 'https://images.unsplash.com/photo-1570727624862-3008fe67a6be?w=600&q=80' },
  { keywords: ['chili sin carne', 'chili con carne'], image: 'https://images.unsplash.com/photo-1666819632298-fe15dc7d4c34?w=600&q=80' },
  { keywords: ['popcorn'], image: 'https://images.unsplash.com/photo-1585647347483-22b66260dfff?w=600&q=80' },
  { keywords: ['bonbons', 'chewing-gum', 'chewing gum'], image: 'https://images.unsplash.com/photo-1582058091505-f87a2e55a40f?w=600&q=80' },
  { keywords: ['cocktail prêt', 'cocktail pret'], image: 'https://images.unsplash.com/photo-1544145945-f90425340c7e?w=600&q=80' },
  { keywords: ['biltong'], image: 'https://images.unsplash.com/photo-1652209695374-7a91c243f12f?w=600&q=80' },

  // --- Belge / Friterie ---
  { keywords: ['fricadelle', 'mexicano', 'viandelle', 'boulette'], image: 'https://images.unsplash.com/photo-1529042410759-befb1204b468?w=600&q=80' },
  { keywords: ['croquette de fromage', 'croquette de crevettes', 'croquette'], image: 'https://images.unsplash.com/photo-1713517915303-ae3b3429f939?w=600&q=80' },
  { keywords: ['gaufre'], image: 'https://images.unsplash.com/photo-1568051243851-f9b136146e97?w=600&q=80' },
  { keywords: ['mousse au chocolat'], image: 'https://images.unsplash.com/photo-1563801802091-1576649a2602?w=600&q=80' },
  { keywords: ['tarte au sucre'], image: 'https://images.unsplash.com/photo-1535920527002-b35e96722eb9?w=600&q=80' },
  { keywords: ['sauce andalouse', 'andalouse', 'samouraï', 'samourai', 'ketchup', 'mayonnaise', 'tartare', 'brazil', 'barbecue', 'aigre-douce', 'cajun'], image: 'https://images.unsplash.com/photo-1518013431117-eb1465fa5752?w=600&q=80' },
  { keywords: ['moules'], image: 'https://images.unsplash.com/photo-1600265721436-734abbfe2137?w=600&q=80' },

  // --- Génériques (fallback) ---
  { keywords: ['kebab', 'durum', 'chawarma', 'grillades', 'grill'], images: ['https://images.unsplash.com/photo-1532636875304-0c89119d9b4d?w=600&q=80', 'https://images.unsplash.com/photo-1719282431565-3b30bb7d2658?w=600&q=80', 'https://images.unsplash.com/photo-1743674453093-592bed88018e?w=600&q=80'] },
  ...
  { keywords: ['wrap'], image: 'https://images.unsplash.com/photo-1752095809096-f09d22c466c5?w=600&q=80' },
  { keywords: ['sandwich', 'panini', 'croque'], images: ['https://images.unsplash.com/photo-1559054663-e8d23213f55c?w=600&q=80', 'https://images.unsplash.com/photo-1528736235302-52922df5c122?w=600&q=80'] },
  { keywords: ['hot-dog', 'hot dog'], image: 'https://images.unsplash.com/photo-1612392061787-2d078b3e573c?w=600&q=80' },
  { keywords: ['glace', 'mochi', 'sorbet', 'sundae', 'cornet'], images: ['https://images.unsplash.com/photo-1629385744299-74b9cf013f52?w=600&q=80', 'https://images.unsplash.com/photo-1572837663132-76c0ccd9cb6f?w=600&q=80'] },
  { keywords: ['cheesecake'], image: 'https://images.unsplash.com/photo-1533134242443-d4fd215305ad?w=600&q=80' },
  { keywords: ['fondant au chocolat', 'chocolate fondant', 'fondant chocolat'], image: 'https://images.unsplash.com/photo-1673551490812-eaee2e9bf0ef?w=600&q=80' },
  { keywords: ['crème brûlée', 'creme brulee'], image: 'https://images.unsplash.com/photo-1676300184943-09b2a08319a3?w=600&q=80' },
  { keywords: ['cookie aux pépites', 'chocolate chip cookie'], image: 'https://images.unsplash.com/photo-1499636136210-6f4ee915583e?w=600&q=80' },
  { keywords: ['tarte aux pommes', 'apple pie', 'apple tart'], image: 'https://images.unsplash.com/photo-1621743478914-cc8a86d7e7b5?w=600&q=80' },
  { keywords: ['brownie'], image: 'https://images.unsplash.com/photo-1606313564200-e75d5e30476c?w=600&q=80' },
  { keywords: ['tiramisu', 'tiramisù'], image: 'https://images.unsplash.com/photo-1571877227200-a0d98ea607e9?w=600&q=80' },
  { keywords: ['panna cotta', 'cannoli'], image: 'https://images.unsplash.com/photo-1488477181946-6428a0291777?w=600&q=80' },
  { keywords: ['chocolat chaud', 'hot chocolate'], image: 'https://images.unsplash.com/photo-1517578239113-b03992dcdd25?w=600&q=80' },
  { keywords: ['chocolat', 'cioccolato', 'cookie', 'biscuit', 'gâteau', 'gateau', 'cake', 'tarte', 'baklava', 'fondant'], images: ['https://images.unsplash.com/photo-1517427294546-5aa121f68e8a?w=600&q=80', 'https://images.unsplash.com/photo-1499636136210-6f4ee915583e?w=600&q=80', 'https://images.unsplash.com/photo-1605807646983-377bc5a76493?w=600&q=80'] },
  { keywords: ['milkshake'], image: 'https://images.unsplash.com/photo-1619158403521-ed9795026d47?w=600&q=80' },
  { keywords: ['fanta'], image: 'https://images.unsplash.com/photo-1624517452488-04869289c4ca?w=600&q=80' },
  { keywords: ['sprite'], image: 'https://images.unsplash.com/photo-1621330716555-5cad596c4562?w=600&q=80' },
  { keywords: ['fuze tea', 'peach iced tea', 'thé glacé pêche', 'ice tea pêche'], image: 'https://images.unsplash.com/photo-1601390395693-364c0e22031a?w=600&q=80' },
  { keywords: ['ice tea', 'iced tea', 'thé glacé', 'the glace'], image: 'https://images.unsplash.com/photo-1499638673689-79a0b5115d87?w=600&q=80' },
  { keywords: ['limonade', 'lemonade', 'limeade', 'citronnade', 'limonata', 'lemon mint'], image: 'https://images.unsplash.com/photo-1621263764928-df1444c5e859?w=600&q=80' },
  { keywords: ['energy drink'], image: 'https://images.unsplash.com/photo-1622543925917-763c34d1a86e?w=600&q=80' },
  { keywords: ['root beer'], image: 'https://images.unsplash.com/photo-1581636625402-29b2a704ef13?w=600&q=80' },
  { keywords: ['coca-cola zero', 'coca zero', 'coke zero'], image: 'https://images.unsplash.com/photo-1543253687-c931c8e01820?w=600&q=80' },
  { keywords: ['coca', 'soda cola'], image: 'https://images.unsplash.com/photo-1554866585-cd94860890b7?w=600&q=80' },
  { keywords: ['softs'], image: 'https://images.unsplash.com/photo-1554866585-cd94860890b7?w=600&q=80' },
  { keywords: ['eau pétillante', 'eau petillante', 'eau gazeuse', 'sparkling water', "san pellegrino", 'acqua panna', 'spa reine'], image: 'https://images.unsplash.com/photo-1548839140-29a749e1cf4d?w=600&q=80' },
  { keywords: ['eau plate', 'still water', 'eau citronnée'], image: 'https://images.unsplash.com/photo-1534616042650-80f5c9b61f09?w=600&q=80' },
  { keywords: ['latte matcha', 'matcha latte'], image: 'https://images.unsplash.com/photo-1536256263959-770b48d82b0a?w=600&q=80' },
  { keywords: ['lait d\'amande', 'lait demi', 'lait entier', 'lait ', 'milk', 'fristi'], image: 'https://images.unsplash.com/photo-1550583724-b2692b85b150?w=600&q=80' },
  { keywords: ['café', 'cafe', 'expresso', 'espresso'], image: 'https://images.unsplash.com/photo-1509042239860-f550ce710b93?w=600&q=80' },
  { keywords: ['bière', 'biere'], image: 'https://images.unsplash.com/photo-1618183479302-1e0aa382c36b?w=600&q=80' },
  { keywords: ['vin', 'prosecco', 'chianti', 'limoncello'], image: 'https://images.unsplash.com/photo-1587920710219-f6f9804dc10d?w=600&q=80' },
  { keywords: ["jus d'orange", 'orange juice', 'jus pressé orange', 'tropicana'], image: 'https://images.unsplash.com/photo-1600271886742-f049cd451bba?w=600&q=80' },
  { keywords: ['jus de pomme', 'apple juice', 'jus pressé pomme'], image: 'https://images.unsplash.com/photo-1727989815707-1b9e8f376775?w=600&q=80' },
  { keywords: ['jus', 'aranciata', 'lemonata', 'mango drink', 'pack sodas', 'pack de sodas'], image: 'https://images.unsplash.com/photo-1622597467821-df79dcb4f94d?w=600&q=80' },
  { keywords: ['thé', 'the', 'tea'], image: 'https://images.unsplash.com/photo-1491720731493-223f97d92c21?w=600&q=80' },
  ...
  { keywords: ['pain', 'croissant', 'viennoiserie', 'éclair', 'eclair', 'cramique', 'financier', 'cannelé', 'canele', 'muffin', 'chausson'], image: 'https://images.unsplash.com/photo-1623334044303-241021148842?w=600&q=80' },
  { keywords: ['poulet', 'chicken'], image: 'https://images.unsplash.com/photo-1763219802762-1d34ee0907c5?w=600&q=80' },
  { keywords: ['beignet'], image: 'https://images.unsplash.com/photo-1570727624862-3008fe67a6be?w=600&q=80' },
  { keywords: ['riz', 'curry', 'cantonais'], images: ['https://images.unsplash.com/photo-1543353071-873f17a7a088?w=600&q=80', 'https://images.unsplash.com/photo-1603133872878-684f208fb84b?w=600&q=80', 'https://images.unsplash.com/photo-1586201375761-83865001e31c?w=600&q=80'] },
  { keywords: ['saumon', 'salmon', 'poisson', 'thon', 'tuna', 'shrimp', 'crevette'], image: 'https://images.unsplash.com/photo-1641898378716-1f38ec04bb0f?w=600&q=80' },
  { keywords: ['chips', 'cacahuète', 'cacahuete', 'bretzel', 'apéro', 'apero', 'olives', 'saucisson', 'fruits secs'], image: 'https://images.unsplash.com/photo-1599490659213-e2b9527bd087?w=600&q=80' },
  { keywords: ['légume', 'legume', 'quiche'], image: 'https://images.unsplash.com/photo-1650844010413-3f24dc1c182b?w=600&q=80' },
  { keywords: ['œufs', 'oeufs', 'eggs'], image: 'https://images.unsplash.com/photo-1518569656558-1f25e69d93d7?w=600&q=80' },
  { keywords: ['salade de fruits', 'fruit salad', 'pommes'], image: 'https://images.unsplash.com/photo-1519996529931-28324d5a630e?w=600&q=80' },
  { keywords: ['salade', 'bowl', 'buddha'], images: ['https://images.unsplash.com/photo-1600335895229-6e75511892c8?w=600&q=80', 'https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=600&q=80', 'https://images.unsplash.com/photo-1543339308-43e59d6b73a6?w=600&q=80'] },
  { keywords: ['soupe', 'soup', 'velouté', 'veloute'], image: 'https://images.unsplash.com/photo-1578861256505-d3be7cb037d3?w=600&q=80' }
];
...
const ITEM_IMAGE_OVERRIDES = {
  ...
  'aigre-douce': U('1775039983749-aa6003c8ecf9'),
  ...
  'beignets de banane': U('1762941904142-9d91ca413e66'),
  'beignets à la banane': U('1762941904142-9d91ca413e66'),
  ...
  'sushi daurade ×2': U('1617196034796-73dfa7b1fd56'),
  ...
  'jupiler 50cl': U('1716339140117-ade27f94c11b'),
  ...
  'filet de bar grillé': U('1644784643137-b9073dd262f6'),
  ...
  'banane frite au miel': U('1762941904142-9d91ca413e66'),
  ...
  'tortilla': U('1788462613199-779ba2bf4b70'),
  ...
  'bouteille de vin maison (75cl)': U('1578911373434-0cb395d2cbfb'),
  ...
  'tarta de santiago': U('1574344069030-b2926f1b3d06'),
  ...
  'magnum (pièce)': U('1572269579647-d941424e3b82'),
  ...
  'rhum 70cl': U('1583552188783-709c90220745'),
  ...
  'hotteok (crêpe fourrée)': U('1620108092667-dd0d0d61df2c'),
  ...
  'thé vert coréen': U('1491720731493-223f97d92c21'),
  ...
  'briouates viande (3 pcs)': U('1572099107898-46f22b3af4f9'),
  'briouates fromage (3 pcs)': U('1572099107898-46f22b3af4f9'),
  ...
  'rfissa': U('1778850790390-c1ba244fbc85'),
  'chorba': U('1682596044586-76c1d9ee1a97'),
  'msemen fourré': U('1633205772834-c0b9943c5a54'),
  'tanjia': U('1773209927906-8a4187066b41'),
  'poulet aux olives': U('1543353071-873f17a7a088'),
  'cornes de gazelle (4 pcs)': U('1475856033578-76b4a228f5c5'),
  'chebakia': U('1499636136210-6f4ee915583e'),
  'baklava marocain': U('1761828122856-8703baac8e86'),
  'sellou': U('1608797178974-15b35a64ede9'),
  ...
  'takoyaki (5 pcs)': U('1742633882704-41ec3a57dbb7'),
  ...
  'fruit tea pêche': U('1684439670717-b1147a7e7534'),
  ...
  'takoyaki (6 pcs)': U('1742633882704-41ec3a57dbb7'),
  'salade wakame': U('1600335895229-6e75511892c8'),
  'soupe miso': U('1680137248903-7af5d51a3350'),
  'tempura crevettes (4 pcs)': U('1579887829114-282b4fa31072'),
  'tempura légumes': U('1779443942390-1257e05015f5'),
  ...
  'thé vert japonais': U('1491720731493-223f97d92c21'),
  ...
  // --- Compléments : les 314 produits des modèles officiels qui n'avaient pas encore de photo
  // (septembre 2026). Photos cherchées plat par plat sur Unsplash, chaque résultat contrôlé par sa
  // description ; quelques produits génériques (softs, bières, thés, frites…) reprennent une photo des
  // pools KEYWORD_IMAGES ci-dessus. Un même produit sous deux noms proches (ex. « Softs » / « Softs 33cl »,
  // « Gyoza poulet » / « Gyoza légumes ») partage volontairement la même photo. ---
  "margherita": U('1513104890138-7c749659a591'),
  "prosciutto": U('1571407970349-bc81e7e96d47'),
  "diavola": U('1590947132387-155cc02f3212'),
  "quattro formaggi": U('1571066811602-716837d681de'),
  "spaghetti bolognese": U('1622973536968-3ead9e780960'),
  "tagliatelle carbonara": U('1588013273468-315fd88ea34c'),
  "ravioli ricotta-épinards": U('1628885363743-fbf9c98d4196'),
  "bruschetta (3 pcs)": U('1506280754576-f6fa8a873550'),
  "focaccia romarin": U('1619452357216-e88ca8119eeb'),
  "mozzarella sticks (6 pcs)": U('1548340748-6d2b7d7da280'),
  "salade césar": U('1607532941433-304659e8198a'),
  "salade caprese": U('1623855244697-5d8fbe9c7892'),
  "tiramisu maison": U('1571877227200-a0d98ea607e9'),
  "glace 2 boules": U('1629385744299-74b9cf013f52'),
  "softs 33cl": U('1554866585-cd94860890b7'),
  "bière 33cl": U('1618183479302-1e0aa382c36b'),
  "vin 25cl": U('1587920710219-f6f9804dc10d'),
  "café": U('1509042239860-f550ce710b93'),
  "onion rings": U('1652209911920-2700fcbd5011'),
  "nuggets (6 pcs)": U('1619881590738-a111d176d906'),
  "coleslaw": U('1573403707491-38a4ea19edc1'),
  "milkshake": U('1619158403521-ed9795026d47'),
  "brownie": U('1606313564200-e75d5e30476c'),
  "cookie": U('1499636136210-6f4ee915583e'),
  "softs": U('1554866585-cd94860890b7'),
  "limonade maison": U('1621263764928-df1444c5e859'),
  "bière artisanale": U('1571613316887-6f8d5cbf7ef7'),
  "eau plate": U('1534616042650-80f5c9b61f09'),
  "jus d'orange pressé": U('1600271886742-f049cd451bba'),
  "maki avocat ×6": U('1579584425555-c3ce17fd4351'),
  "spring rolls saumon avocat cheese ×6": U('1679310290259-78d9eaa32700'),
  "chirashi saumon": U('1553621042-f6e147245754'),
  "poulet teriyaki riz": U('1609183480237-ccbb2d7c5772'),
  "edamame": U('1649257171206-37625b1f3b2f'),
  "gyoza poulet (5 pcs)": U('1738681336104-608b4e7dc3b0'),
  "mochi (2 pcs)": U('1541014741259-de529411b96a'),
  "perles de coco": U('1596723455658-72ebb0d12edd'),
  "thé vert": U('1606377695906-236fdfcef767'),
  "bière asahi": U('1624819592966-0b5ce5dfd1a9'),
  "saké": U('1664477407933-dd42ed0c6c62'),
  "carpaccio de bœuf": U('1727243866425-3bf2cbf7480a'),
  "arancini (3 pcs)": U('1632778140142-d62dee6e124c'),
  "gnocchi gorgonzola": U('1616170687881-32188ae1b6d7'),
  "affogato": U('1461023058943-07fcbe16d735'),
  "aperol spritz": U('1570598912132-0ba1dc952b7d'),
  "espresso": U('1572286258217-40142c1c6a70'),
  "croquettes de fromage (2 pcs)": U('1785031620399-c56a45c4af63'),
  "tomate crevettes": U('1751152841080-dedb3b716b83'),
  "boulets sauce lapin, frites": U('1768187067375-4cd5a79fec41'),
  "vol-au-vent, frites": U('1762160964307-3711080c33e1'),
  "carbonnades flamandes, frites": U('1445979323117-80453f573b71'),
  "waterzooi de poulet": U('1697155406127-76096502d69d'),
  "spaghetti bolognaise": U('1622973536968-3ead9e780960'),
  "croque-madame": U('1528736235302-52922df5c122'),
  "gaufre de bruxelles chantilly": U('1773516035322-e413a151ad14'),
  "mousse au chocolat": U('1563801802091-1576649a2602'),
  "tarte du jour": U('1620980776848-84ac10194945'),
  "nems poulet (4 pcs)": U('1679310290259-78d9eaa32700'),
  "gyoza (5 pcs)": U('1738681336104-608b4e7dc3b0'),
  "soupe tom yum": U('1761037994516-502ed10932b0'),
  "salade de papaye verte": U('1648421331147-9fcfab29536e'),
  "ramen poulet": U('1740813626726-d811be64edbf'),
  "bœuf aux oignons": U('1664138788119-bd4f073259d5'),
  "crevettes basilic thaï": U('1675620065812-c69e268ed241'),
  "canard laqué": U('1518492104633-130d0cc84637'),
  "tofu légumes": U('1764674963000-0d113663bc0d'),
  "curry vert poulet": U('1716959669858-11d415bdead6'),
  "menu duo (2 entrées + 2 plats + riz)": U('1626775061010-cdf275c24bc5'),
  "perles de coco (2 pcs)": U('1596723455658-72ebb0d12edd'),
  "mango sticky rice": U('1711161988375-da7eff032e45'),
  "bubble tea": U('1558857563-b371033873b8'),
  "bowl poulet grillé avocat": U('1761315600943-d8a5bb0c499f'),
  "bowl saumon teriyaki": U('1771384552858-feb0574f958d'),
  "bowl falafel houmous": U('1680990999782-ba7fe26e4d0b'),
  "bowl tofu curry": U('1625540002162-00320b5c6b63'),
  "bowl bœuf sésame": U('1679279726937-122c49626802'),
  "salade césar light": U('1607532941433-304659e8198a'),
  "salade chèvre chaud noix miel": U('1608032077018-c9aad9565d29'),
  "salade halloumi grenade": U('1598511796432-32663d0875bd'),
  "salade poulet mangue": U('1646487793655-bbf280273d2f'),
  "chia pudding": U('1517093157656-b9eccef91cb1'),
  "açaí bowl": U('1684403620650-81dc661a69db'),
  "energy balls (3 pcs)": U('1678554500191-3885a6fbf8c2'),
  "cookie protéiné": U('1499636136210-6f4ee915583e'),
  "jus pressé": U('1622597467821-df79dcb4f94d'),
  "smoothie": U('1610970881699-44a5587cabec'),
  "kombucha": U('1783099993801-c31173919b72'),
  "matcha latte": U('1536256263959-770b48d82b0a'),
  "burrata rôtie aux légumes": U('1623855244697-5d8fbe9c7892'),
  "croquettes de champignons (2 pcs)": U('1785031620399-c56a45c4af63'),
  "tempura de légumes": U('1779443942390-1257e05015f5'),
  "buddha bowl (quinoa, avocat, falafel, houmous)": U('1505576633757-0ac1084af824'),
  "curry de légumes, lait de coco, riz": U('1587040690786-b091531837a2'),
  "risotto aux champignons": U('1682428617976-f25633ed8469'),
  "lasagne végétarienne": U('1621996346565-e3dbc646d9a9'),
  "burger vegan (steak végétal, frites)": U('1610970878459-a0e464d7592b'),
  "chili sin carne, riz": U('1666819632298-fe15dc7d4c34'),
  "gnocchis épinards gorgonzola": U('1616170687881-32188ae1b6d7'),
  "assiette mezze végétarien": U('1743674453093-592bed88018e'),
  "menu midi (plat du jour + soupe)": U('1581347860118-588a42326161'),
  "cheesecake vegan": U('1533134242443-d4fd215305ad'),
  "moelleux chocolat": U('1605807646983-377bc5a76493'),
  "crumble aux pommes": U('1696629958314-3d1cf2cbce69'),
  "vin bio au verre": U('1553361371-9b22f78e8b1d'),
  "bière bio": U('1716339140117-ade27f94c11b'),
  "fricadelle": U('1529042410759-befb1204b468'),
  "chicken nuggets (6 pcs)": U('1619881590738-a111d176d906'),
  "burger bodrum (steak, cheddar, oignons grillés)": U('1571091718767-18b5b1457add'),
  "baklava (3 pièces)": U('1761828122856-8703baac8e86'),
  "sütlaç (riz au lait)": U('1590055619273-44b5b6ce52e8'),
  "künefe": U('1619860862294-1e96abc03d5b'),
  "ayran": U('1558113583-d75f23fcb8a9'),
  "thé turc": U('1564890369478-c89ca6d9cde9'),
  "tacos poulet mariné": U('1644085128237-9ba593123ac3'),
  "burrito bowl (sans tortilla)": U('1543339308-43e59d6b73a6'),
  "fajitas poulet (à composer)": U('1689773976415-293dd893f77e'),
  "fajitas crevettes": U('1762631882052-bb8aea869735'),
  "chili con carne riz": U('1666819632298-fe15dc7d4c34'),
  "guacamole & totopos": U('1600728256404-aaa448921ad9'),
  "nachos supreme (fromage, jalapeños, pico de gallo)": U('1582169296194-e4d644c48063'),
  "quesadilla fromage": U('1618040996337-56904b7850b9'),
  "churros dulce de leche": U('1702896287488-0a83b9baaab9'),
  "tres leches": U('1557925923-33b27f891f88'),
  "jarritos": U('1632852521784-d85d5b62dd62'),
  "houmous": U('1673960854897-749f9d9ebafc'),
  "sandwich halloumi grillé": U('1598511796432-32663d0875bd'),
  "grillades mixtes": U('1532636875304-0c89119d9b4d'),
  "fatteh poulet": U('1786174045055-1eb50942e273'),
  "baklava (4 pcs)": U('1761828122856-8703baac8e86'),
  "jus de grenade": U('1603028769333-009800f4e059'),
  "thé à la menthe": U('1591299089616-c9604047b1a6'),
  "café arabe": U('1604924434662-4127d9fa3070'),
  "croquetas jamón (4 pcs)": U('1785031620399-c56a45c4af63'),
  "churros con chocolate": U('1702896287488-0a83b9baaab9'),
  "tenders 4 pcs": U('1626645738196-c2a7c87a8f58'),
  "wings 6 pcs": U('1608039755401-742074f0548d'),
  "wrap spicy": U('1752095809096-f09d22c466c5'),
  "menu burger + frites + boisson": U('1547754070-c73f90c116b5'),
  "menu tenders 4 pcs + frites + boisson": U('1626645738196-c2a7c87a8f58'),
  "menu famille (12 pcs + 2 grandes frites + 1,5l)": U('1694853651800-3e9b4aa96a42'),
  "corn on the cob": U('1653886764193-db9e5a93d215'),
  "mac & cheese": U('1667499989723-c4ab9549d63c'),
  "avocado toast": U('1603046891726-36bfd957e0bf'),
  "toast burrata tomates": U('1649400454485-b8ad827f929d'),
  "croque": U('1528736235302-52922df5c122'),
  "chocolat chaud": U('1517578239113-b03992dcdd25'),
  "thé en feuilles": U('1563822249366-3efb23b8e0c9'),
  "tarte aux pommes entière (6-8 pers.)": U('1621743478914-cc8a86d7e7b5'),
  "café à emporter": U('1615485736894-a2d2e6d4cd9a'),
  "frites fraîches (kg)": U('1573080496219-bb080dd4f877'),
  "œufs (6)": U('1506976785307-8732e854ad03'),
  "boulettes (pièce)": U('1529042410759-befb1204b468'),
  "brochettes marinées (pièce)": U('1529006557810-274b9b2fc783'),
  "lasagne (portion)": U('1621996346565-e3dbc646d9a9'),
  "salade de pâtes (portion)": U('1473093295043-cdd812d0e601'),
  "houmous nature 200g": U('1673960854897-749f9d9ebafc'),
  "biltong bœuf séché": U('1652209695374-7a91c243f12f'),
  "pizza surgelée": U('1600028068383-ea11a7a101f3'),
  "pâtes fraîches": U('1612966893103-790e549a2ab1'),
  "soupe en brique": U('1615589484252-c70def71bb4f'),
  "salade composée": U('1667657682263-86e924b34fd9'),
  "riz basmati 1kg": U('1586201375761-83865001e31c'),
  "conserve ravioli": U('1646188803323-14676b477166'),
  "paquet de biscuits": U('1672753261221-608b9d15d597'),
  "yaourt aux fruits (4)": U('1571212515416-fef01fc43637'),
  "glace vanille 1l": U('1628815870980-f416105d89b3'),
  "donut chocolat": U('1562945431-ce2b63d5a7fe'),
  "barres céréales (6)": U('1633360821154-1935fb5671e6'),
  "coca-cola 1.5l": U('1567103472667-6898f3a79cf2'),
  "coca-cola zero 1.5l": U('1543253687-c931c8e01820'),
  "sprite 1.5l": U('1621330716555-5cad596c4562'),
  "eau plate 1.5l": U('1534616042650-80f5c9b61f09'),
  "eau pétillante 1.5l": U('1548839140-29a749e1cf4d'),
  "pack de sodas 6x33cl": U('1527960471264-932f39eb5846'),
  "café moulu 250g": U('1511920170033-f8396924c348'),
  "lait demi-écrémé 1l": U('1550583724-b2692b85b150'),
  "thé glacé 1.5l": U('1499638673689-79a0b5115d87'),
  "lait 1l": U('1550583724-b2692b85b150'),
  "pâtes 500g": U('1551462147-ff29053bfc14'),
  "café moulu": U('1511920170033-f8396924c348'),
  "biscuits (oreo, prince)": U('1672753261221-608b9d15d597'),
  "glace ben & jerry's 465ml": U('1562790879-dfde82829db0'),
  "coca-cola 33cl": U('1554866585-cd94860890b7'),
  "coca-cola zero 33cl": U('1543253687-c931c8e01820'),
  "fanta 33cl": U('1624517452488-04869289c4ca'),
  "sprite 33cl": U('1621330716555-5cad596c4562'),
  "ice tea 33cl": U('1499638673689-79a0b5115d87'),
  "eau pétillante 50cl": U('1548839140-29a749e1cf4d'),
  "jus (looza, minute maid) 33cl": U('1622597467821-df79dcb4f94d'),
  "vin rouge / blanc / rosé": U('1578911373434-0cb395d2cbfb'),
  "poke bowl poulet teriyaki": U('1759429179911-4e1f0e4e69f7'),
  "poke bowl bœuf épicé": U('1490645935967-10de6ba17061'),
  "salade de wakame": U('1690789627117-eb8d3b6a46f4'),
  "gyoza légumes (4 pcs)": U('1738681336104-608b4e7dc3b0'),
  "mochi (3 pcs)": U('1541014741259-de529411b96a'),
  "salade de fruits frais": U('1519996529931-28324d5a630e'),
  "thé glacé maison": U('1499638673689-79a0b5115d87'),
  "eau de coco": U('1603779046675-2eccbab9b982'),
  "limonade au yuzu": U('1621263764928-df1444c5e859'),
  "salade de papaye verte (som tam)": U('1648421331147-9fcfab29536e'),
  "soupe tom yum crevettes": U('1761037994516-502ed10932b0'),
  "beignets de crevettes (5 pcs)": U('1759823338930-7996c1787c3b'),
  "satay de poulet (4 brochettes)": U('1772855386828-a18ff9a12584'),
  "riz sauté au basilic, poulet (pad kra pao)": U('1603133872878-684f208fb84b'),
  "nouilles sautées aux légumes": U('1585032226651-759b368d7246'),
  "riz gluant à la mangue": U('1705234384751-84081009588e'),
  "glace au coco": U('1620197544618-af5f5366abb3'),
  "thé thaï glacé": U('1583124252668-93a11eb64a5f'),
  "bière singha": U('1618183479302-1e0aa382c36b'),
  "samoussas légumes (3 pcs)": U('1601050690597-df0568f70950'),
  "soupe mulligatawny": U('1613844237701-8f3664fc2eff'),
  "naan au fromage": U('1697155406014-04dc649b0953'),
  "butter chicken": U('1631452180519-c014fe946bc7'),
  "curry d'agneau": U('1596797038530-2c107229654b'),
  "aloo gobi (curry pommes de terre chou-fleur)": U('1627906296851-6d9c5e4db592'),
  "vindaloo poulet": U('1708782344490-9026aaa5eec7'),
  "kulfi (glace indienne)": U('1561588012-17a0e1119c0e'),
  "riz au lait à la cardamome": U('1590055619273-44b5b6ce52e8'),
  "nems (rouleaux impériaux, 4 pcs)": U('1679310290259-78d9eaa32700'),
  "salade de papaye verte au bœuf séché": U('1648421331147-9fcfab29536e'),
  "soupe won ton": U('1559948271-7d5c98d2e951'),
  "bún bò huế": U('1766050586763-723571af4dde'),
  "bo bun bœuf grillé": U('1763703544688-2ac7839b0659'),
  "bánh mì poulet": U('1715925717159-92e29c32ad06'),
  "bánh mì porc grillé": U('1715925717150-2a6d181d8846'),
  "cơm tấm (porc grillé, riz brisé)": U('1766050587783-1c90751275dd'),
  "chè (dessert coco et haricots)": U('1596723455658-72ebb0d12edd'),
  "café vietnamien glacé (cà phê sữa đá)": U('1578314675249-a6910f80cc4e'),
  "thé glacé": U('1499638673689-79a0b5115d87'),
  "raviolis vapeur au porc (6 pcs)": U('1534422298391-e4f8c172dddb'),
  "soupe wonton": U('1559948271-7d5c98d2e951'),
  "canard laqué (portion)": U('1518492104633-130d0cc84637'),
  "poulet general tao": U('1664138788119-bd4f073259d5'),
  "nouilles sautées cantonaises": U('1635685296916-95acaf58471f'),
  "crevettes sauce piquante": U('1599655345131-6eb73b81d8d6'),
  "chow mein légumes": U('1634864572865-1cf8ff8bd23d'),
  "glace au litchi": U('1613294620941-21ba8e42dd5a'),
  "thé au jasmin": U('1609016617751-e80552ae6ec2'),
  "bière tsingtao": U('1618183479302-1e0aa382c36b'),
  "glace boule (1 parfum)": U('1560008581-09826d1de69e'),
  "donut glaçage classique": U('1570727624862-3008fe67a6be'),
  "gaufre de liège nature": U('1607914450649-fbef8a448fec'),
  "crêpe sucre": U('1656057205408-4a0a62cf2dfb'),
  "milkshake vanille": U('1619158401201-8fa932695178'),
  "milkshake chocolat": U('1619158403521-ed9795026d47'),
  "part de cheesecake": U('1533134242443-d4fd215305ad'),
  "fondant au chocolat": U('1673551490812-eaee2e9bf0ef'),
  "viennoiserie au choix": U('1555507036-ab1f4038808a'),
  "granola yaourt fruits": U('1641536885341-301aeb52f1c0'),
  "toast avocat": U('1603046891726-36bfd957e0bf'),
  "pancakes nature (3 pcs)": U('1541288097308-7b8e3f58c4c6'),
  "pancakes sirop d'érable fruits rouges": U('1612182062633-9ff3b3598e96'),
  "œufs brouillés bacon": U('1618666185600-1f9f09d5eb2c'),
  "bagel saumon fumé": U('1601585099780-6b176dc702af'),
  "thé": U('1491720731493-223f97d92c21'),
  "smoothie fruits": U('1610970881699-44a5587cabec'),
  "salade verte": U('1623489254660-db5b367881d9'),
  "sandwich poulet crudités": U('1700937244987-92488ab2ada5'),
  "wrap poulet césar": U('1626700051175-6818013e1d4f'),
  "wrap falafel houmous": U('1748955308143-5055af50bba6'),
  "wrap thon": U('1563282397-cdc218eccfda'),
  "salade grecque": U('1606735584785-1848fdcaea57'),
  "salade niçoise": U('1655271553809-d200a1240bf6'),
  "salade quinoa avocat": U('1763000215238-38350d3e41ac'),
  "bagel saumon fromage frais": U('1601585099780-6b176dc702af'),
  "muffin": U('1623334044303-241021148842'),
  "salade de fruits": U('1519996529931-28324d5a630e'),
  "accras de morue (5 pcs)": U('1696265498747-efc4c0dd7b98'),
  "salade avocat mangue": U('1562629609-49c10e58c2a6'),
  "soupe à l'arachide": U('1547592166-23ac45744acd'),
  "mafé poulet": U('1661588669110-81142a5b9e57'),
  "thiéboudienne (riz au poisson)": U('1512058564366-18510be2db19'),
  "yassa poulet": U('1757715377796-2a368ec7499e'),
  "alloco (bananes plantains frites)": U('1762884601729-0eeeafbdfb8a'),
  "poulet braisé (poulet dg)": U('1574803636191-b2bbb307e9c6'),
  "riz gras": U('1665332195309-9d75071138f0'),
  "kedjenou de poulet": U('1604908176997-125f25cc6f3d'),
  "foutou sauce claire": U('1763048443535-1243379234e2'),
  "gâteau à l'ananas": U('1643910509872-78bc24a2bc53'),
  "bissap (hibiscus)": U('1598905875667-745166844c96'),
  "soupe de poisson": U('1682596044586-76c1d9ee1a97'),
  "carpaccio de saumon": U('1779738193214-fb11a306033a'),
  "plateau de moules marinière (mise en bouche)": U('1600265721436-734abbfe2137'),
  "fish & chips (cabillaud)": U('1697748836791-9ddf7e616ece'),
  "moules marinière frites": U('1715249792920-bfe1a3b9d79e'),
  "cabillaud grillé légumes": U('1733554080207-754bfedf4864'),
  "saumon grillé légumes": U('1633524792246-f25f5b0d66dc'),
  "plateau de fruits de mer (1 pers.)": U('1572776082973-1cb8d1790872'),
  "croquettes de crevettes grises, frites": U('1626011852881-4609127619a8'),
  "tarte au riz": U('1554298128-c916518a4b34'),
  "vin blanc (verre)": U('1585553616435-2dc0a54e271d'),
  "bière blanche": U('1730390772423-e701d895e0bb'),
  "croquette de fromage": U('1785031620399-c56a45c4af63'),
  "bicky burger": U('1571091718767-18b5b1457add'),
  "brochette de poulet": U('1529006557810-274b9b2fc783'),
  "beignet": U('1784649844526-cf8a1c060858'),
  "churros": U('1702896287488-0a83b9baaab9'),
  "glace (cornet)": U('1497034825429-c343d7c6a68f'),
  "coca-cola": U('1554866585-cd94860890b7'),
  "coca-cola zero": U('1543253687-c931c8e01820'),
  "fanta": U('1624517452488-04869289c4ca'),
  "sprite": U('1621330716555-5cad596c4562'),
  "ice tea": U('1499638673689-79a0b5115d87'),
  "chimay bleue": U('1759306441537-7fae35fec66f'),
  "japchae (nouilles sautées)": U('1524859880053-f595797051c2'),
  "kimbap saumon (8 pcs)": U('1608731002466-057222dc4989'),
  "soupe miso coréenne": U('1680137248903-7af5d51a3350'),
  "café glacé coréen": U('1578314675249-a6910f80cc4e'),
  "houmous marocain": U('1673960854897-749f9d9ebafc'),
  "pain marocain (khobz)": U('1608198093002-ad4e005484ec'),
  "café marocain": U('1695593217066-1e663f8524db'),
...
// Galerie de photos proposée pour UNE section d'UN type de commerce (entrées, plats, desserts,
// boissons — ou une section personnalisée ramenée à l'une des quatre). D'abord les photos des plats de
// cette section dans le modèle officiel du type — ce sont exactement les plats que le restaurateur va
// nommer — puis, pour les desserts et boissons, les classiques Fairide communs à tous les types, et
// pour les entrées et plats la galerie libre du type (galleryImages.js). Alimente le sélecteur de photos
// (GalleryPickerModal, prop `suggestions`) quand le restaurateur illustre une section ou un plat.
export function galleryForSection(cuisine, sectionName, max = 30) {
  const v = (sectionName || '').toLowerCase();
  const kind = categoryKind(sectionName) || (sectionName === 'entree' || CATEGORY_HINT_ENTREE.test(v) ? 'entree' : 'plat');
  const urls = [];
  const ajouter = (u) => { if (u && !urls.includes(u)) urls.push(u); };
  fullTemplateItems(cuisine).forEach((it) => { if (it.category === kind) ajouter(defaultItemImageOrNull(it)); });
  if (kind === 'dessert' || kind === 'boisson') {
    // Un tiramisu est un tiramisu, une limonade une limonade : les desserts et boissons des autres types
    // de commerce valent aussi pour celui-ci — après les classiques Fairide.
    (kind === 'dessert' ? CLASSIC_DESSERTS : CLASSIC_DRINKS).forEach((d) => ajouter(defaultItemImageOrNull(d)));
    RESTAURANT_TYPES.forEach((t) => {
      if (t.value === cuisine || urls.length >= max) return;
      fullTemplateItems(t.value).forEach((it) => { if (it.category === kind) ajouter(defaultItemImageOrNull(it)); });
    });
  }
